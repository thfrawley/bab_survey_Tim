...
##Load first file
SD<-read.csv("Input_Data/P2/bab_survey_2025_in_person_honorarium_SD.csv")
####Add in ID info to track versions
SD$Version<-"P2_SD_Honor."
SD$Mechanism<-"In_Person"

##Load second file
Sonoma<-read.csv("Input_Data/P2/bab_survey_2025_in_person_honorarium_sonoma.csv")
####Add in ID info to track versions
...
##Load third file
LA<-read.csv("Input_Data/P2/bab_survey_2025_in_person_honorarium_la.csv")
####Add in ID info to track versions
...
###Load 4th file
HDN<-read.csv("Input_Data/P2/bab_survey_2025_in_person_honorarium_hdn.csv")
####Add in ID info to track versions
...
###Load 5th file
SB<-read.csv("Input_Data/P2/bab_survey_2025_in_person_honorarium_hdn.csv")
####Add in ID info to track versions
...
###Load 6th file
Template<-read.csv("Input_Data/P2/Survey_UCSB_Final_2025_template.csv")
...
Online_Prize<-read.csv("Input_Data/P2/bab_survey_2025_online_prize.csv")
####Add in ID info to track versions
Online_Prize$Version<-"P2_Online_Prize"
Online_Prize$Mechanism<-"Online"

##Load in second prize file
SoCal_Prize<-read.csv("Input_Data/P2/bab_survey_2025_in_person_prize_socal.csv")
####Add in ID info to track versions
...
NorCal_Prize<-read.csv("Input_Data/P2/bab_survey_2025_in_person_prize_norcal.csv")
####Add in ID info to track versions
...
Tribal<-read.csv("Input_Data/P2/Survey_Final_V3_Tribal_pilot.csv")
